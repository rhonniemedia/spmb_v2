    ...
    <div class="relative rounded-card overflow-hidden mb-6 p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 bg-gradient-to-br from-primary via-[#D90F38] to-[#B00F30] animate-fade-in">
        ...
        <div class="relative z-10 w-full md:flex-1 text-center md:text-left">
            <div class="inline-flex items-center gap-1.5 bg-white/20 text-white text-[12px] font-bold px-3 py-1 rounded-full mb-3 border border-white/20 tracking-wider">
                <i class="fa-solid fa-circle-dot text-[8px] animate-pulse"></i> Status Pendaftaran
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                ...
                <a href="{{ route('biodata') }}"
                    class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-white/20 text-white text-[13px] font-bold rounded-full no-underline border border-white/30 hover:bg-white/30 transition-all">
                ...
                <div class="max-h-[400px] overflow-y-auto">
                    ...
                    <div class="p-4 border-b border-gray-50 hover:bg-gray-50 transition-colors cursor-pointer group">
                        <div class="flex gap-3">
                            <div class="mt-1 flex-shrink-0"><div class="w-2 h-2 rounded-full bg-primary"></div></div>
                            <div>

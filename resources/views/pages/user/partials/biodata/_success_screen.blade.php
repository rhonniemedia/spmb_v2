<div x-show="isSubmitted" x-transition
    ...
    <div class="inline-flex flex-col gap-2 bg-gray-50 border border-gray-200 rounded-2xl px-8 py-5 mb-8 text-left">
        ...
        <div class="flex gap-4 text-sm">
            ...
            {{--
                Resolusi status — gabungan PHP + Alpine:
                - PHP menyediakan nilai default dari DB saat halaman dimuat
                - Alpine override via submitResult.profile_status dari response POST /biodata/submit
                  sehingga kasus baru-submit pun langsung menampilkan 'final' tanpa reload
            --}}
            @php
    ...
    <div class="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <div class="relative group inline-flex">
            <button disabled
                class="px-8 py-3 bg-gray-200 text-gray-400 rounded-full text-base font-bold cursor-not-allowed transition-all">
                <i class="fa-solid fa-arrow-right mr-2"></i> Lanjut ke Pendaftaran
            </button>

            {{-- Tooltip jadwal --}}
            <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max max-w-[220px] bg-[#080C1A] text-white text-xs font-medium rounded-xl px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none text-center leading-relaxed">

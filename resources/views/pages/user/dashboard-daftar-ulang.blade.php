                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-start gap-3 pb-4 border-b border-white/10 sm:pb-0 sm:border-b-0">
                            ...
                            <div>
                                ...
                                @if($jadwalJam !== '-')
                                <p class="text-sm font-bold text-white">08.00 - 16.00 WIB</p>
                                @else
        ...
        <div class="grid xl:grid-cols-5 gap-6">
            ...
            <div class="xl:col-span-3 bg-white rounded-2xl border border-[#e5e7eb] flex flex-col">
                ...
                <div class="p-6 grid sm:grid-cols-2 gap-4 flex-1">
                    ...
                    <a href="{{ route('laporan-kelulusan') }}" target="_blank"
                    ...
                    @php
                    // $reRegistrationData sudah disiapkan controller (array via compact),
                    // hanya terisi saat $isReRegistrationActive === true — yang mana
                    // pasti berlaku di view ini, tapi tetap pakai null-safe untuk jaga-jaga.
                    $sudahDaftarUlang = $reRegistrationData['isReRegistered'] ?? false;
                    $tanggalDaftarUlang = $reRegistrationData['reRegisteredAt'] ?? null; // sudah string terformat
                    @endphp
                    ...
                    <a href="{{ route('laporan-daftar-ulang') }}" target="_blank"
                        ...
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span class="text-[10px] font-bold bg-[#0a7c2f]/10 text-[#0a7c2f] px-2 py-0.5 rounded-full">Selesai</span>
                        </div>
                        <p class="font-bold text-[#080c1a]">Bukti Registrasi Ulang</p>
                        <p class="text-xs text-[#6a7686] mt-1 leading-5">
                            Daftar ulang tercatat pada {{ $tanggalDaftarUlang ?? '-' }}.
                        </p>
                        <div class="mt-auto pt-4 flex items-center gap-1 text-xs font-bold text-[#3b82f6] group-hover:gap-2 transition-all duration-200">
                            <i data-lucide="download" class="w-3.5 h-3.5"></i> Unduh Bukti
                        </div>
                    </a>
                    @else
                    <div class="group rounded-2xl border border-[#e5e7eb] p-5 flex flex-col opacity-90 cursor-not-allowed" title="Tersedia setelah kamu menyelesaikan proses daftar ulang">
                        <div class="flex items-start justify-between mb-4">
                    ...
                    @if($personalData && $isPersonalDataComplete)
                    <a href="{{ route('laporan-surat-pernyataan') }}" target="_blank"
                    ...
                    <a href="#"
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="w-12 h-12 rounded-2xl bg-[#9ca3af]/10 flex items-center justify-center">
                                <i data-lucide="file-signature" class="w-6 h-6 text-[#9ca3af]"></i>
                            </div>
                            <span class="text-[10px] font-bold bg-[#fef9c3] text-[#92400e] px-2 py-0.5 rounded-full">Belum Lengkap</span>
                        </div>
                        <p class="font-bold text-[#080c1a]">Surat Pernyataan</p>
                        <p class="text-xs text-[#6a7686] mt-1 leading-5">Lengkapi & finalisasi biodata dulu untuk bisa cetak PDF.</p>
                        <div class="mt-auto pt-4 flex items-center gap-1 text-xs font-bold text-[#9ca3af] transition-all duration-200">
                            <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i> Lengkapi Biodata
                        </div>
                    </a>
                    @endif

                    @if($personalData && $isPersonalDataComplete)
                    <a href="{{ route('laporan-biodata') }}" target="_blank"
                    ...
                    <a href="#"
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="w-12 h-12 rounded-2xl bg-[#9ca3af]/10 flex items-center justify-center">
                                <i data-lucide="file-down" class="w-6 h-6 text-[#9ca3af]"></i>
                            </div>
                            <span class="text-[10px] font-bold bg-[#fef9c3] text-[#92400e] px-2 py-0.5 rounded-full">Belum Lengkap</span>
                        </div>
                        <p class="font-bold text-[#080c1a]">Formulir Data Pribadi</p>

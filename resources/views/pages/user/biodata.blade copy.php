...
══════════════════════════════════════════ --}}
    ...
    <div class="lg:grid lg:grid-cols-[1fr_340px] lg:gap-6 lg:items-start" x-show="!isSubmitted">
        ...
        <div class="min-w-0">
            ...
            {{-- STEPPER --}}
            @include('pages.user.partials._stepper')

            <form id="biodata-form"
                enctype="multipart/form-data"
                @submit.prevent>

                @include('pages.user.partials._step1_pribadi')
                @include('pages.user.partials._step2_alamat')
                @include('pages.user.partials._step3_orangtua')
                @include('pages.user.partials._step4_pendidikan')
                @include('pages.user.partials._step5_foto')
                @include('pages.user.partials._step6_konfirmasi')

            </form>
        </div>{{-- /main col --}}

        <!-- SIDEBAR -->
        @include('pages.user.partials._sidebar')


    </div>{{-- /two-col grid --}}

    <!-- SUCCESS SCREEN -->
    @include('pages.user.partials._success_screen')

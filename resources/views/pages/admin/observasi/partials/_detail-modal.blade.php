        ...
        <div class="flex-1 overflow-y-auto p-6 md:p-8">
            ...
            <div class="mt-8 pt-6 border-t border-dashed border-border">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    {{-- Box 2: Info Pembaruan --}}
                    <div class="rounded-xl px-4 py-3 bg-muted/50 flex items-start gap-3">
                        <div class="size-8 rounded-full bg-orange-50 flex items-center justify-center shrink-0 border border-orange-100 shadow-sm">
                            <i data-lucide="history" class="size-4 text-orange-600"></i>
                        </div>
                        <div class="min-w-0">

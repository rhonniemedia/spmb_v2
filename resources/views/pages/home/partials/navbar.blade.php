    ...
    <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-6">
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="flex items-center gap-3">
                ...
                <div>
                    <p class="font-display font-bold text-white leading-tight text-sm">Portal SPMB</p>
                    <p class="text-xs text-cyan-400/70 leading-tight font-medium tracking-wide">{{ $g_schoolInfo->name }}</p>
                </div>
            </a>
